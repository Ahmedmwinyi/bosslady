...
export default function DeanDashboard() {
  ...
  const getPendingApplications = () => {
    return promotionRequests.filter(
      (app) => app.status === "UNDER_DEAN_REVIEW"
    );
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-2 lg:px-0">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Welcome, Dean {user?.fullName}!</p>
      </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Applications needing your action
              </p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 text-sm">From your school</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 text-sm">{user?.schoolName}</p>
            </div>
          ...
          <div className="mt-4 text-sm text-gray-600">
            {promotionRequests.length} applications this cycle
          </div>
        </div>
      </div>
          ...
          {getPendingApplications().length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-4">
                All applications in your school have been reviewed.
              </p>
            </div>
          ) : (
